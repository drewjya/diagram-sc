PROJECT_TILE = "Add Retest Result Activity";

function addRetestResult() {
  ...
  const clickDiscussionTab = createActivity("Click Retest Tab", 125, 895, user);
  createLink(
    displayFindingDetailActivity,
    clickDiscussionTab,
    { sourceSide: "left" },
  ...
  const clickAddRetest = createActivity("Click Add\nRetest", 125, 995, user);
  ...
  const insertRetestField = createActivity(
    "Insert Retest Field",
    125,
    1095,
    user
  ...
  const sendRetestInformation = createActivity(
    "Send New\nRetest Information",
    125,
    1195,
    user
  ...
  createLink(
    clickAddRetest,
    sendRetestInformation,
    { sourceSide: "bottom" },
    { targetSide: "top" }
  );

  const saveRetestInformation = createActivity(
    "Save Retest\nInformation",
    125,
    1295,
    system
  ...
  createLink(
    sendRetestInformation,
    saveRetestInformation,
    { sourceSide: "bottom" },
    { targetSide: "top" }
  );

  const broadcastToFinding = createActivity(
    "Broadcast to\nFinding Event",
    125,
    1395,
    system
  ...
  const finishNode = createEndNode(210, 1475, system);
  createLink(
    broadcastToFinding,
    finishNode,
    { sourceSide: "bottom" },
