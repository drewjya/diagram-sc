PROJECT_TILE = "Delete Member Project Activity";

function deleteMemberActivity() {
  ...
  const clickInviteMember = createActivity(
    "Select Member\nTo Delete",
    125,
    775,
    user
  ...
  const clickSendRequest = createActivity("Click Delete", 125, 975, user);
  createLink(
    fillMemberRequirement,
    clickSendRequest,
    { sourceSide: "bottom" },
