PROJECT_TILE = "Delete Subproject Activity";
...
function deleteSubproject() {
    ...
    const saveDateNode = createActivity("Delete Subproject", 125, 675, system);
    ...
    const finishNode = createEndNode(210, 875, system);
    createLink(
      broadcastSubprojectProject,
      finishNode,
      { sourceSide: "bottom" },
